...
// Replace DOMContentLoaded inline handler with a reusable function and keep DOMContentLoaded for non-SPA
(function () {
  // Start of extracted function
  function renderDashboardAnalytics() {
    ...
    const orderAreaChartEl = document.querySelector('#orderChart'),
      orderAreaChartConfig = {
        ...
        grid: { show: false, padding: { top: 15, right: 7, left: 0 } },
        ...
        xaxis: { show: false, lines: { show: false }, labels: { show: false }, stroke: { width: 0 }, axisBorder: { show: false } },
        yaxis: { stroke: { width: 0 }, show: false }
      };
    if (typeof orderAreaChartEl !== undefined && orderAreaChartEl !== null && orderAreaChartEl.childElementCount === 0) {
  ...
  // Attach globally so React can call it after mount
  window.renderDashboardAnalytics = renderDashboardAnalytics;

  // Still run automatically on normal page loads
