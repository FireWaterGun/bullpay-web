...
export default function PaySelect() {
  ...
  const filteredGroups = useMemo(() => {
    ...
    return coinGroups.filter(
      (g) =>
        g.symbol.toLowerCase().includes(q) ||
        g.name.toLowerCase().includes(q) ||
        g.networks.some(
          (n) =>
            (n.network?.name || '').toLowerCase().includes(q) || (n.network?.symbol || '').toLowerCase().includes(q)
        )
    )
      ...
      <div className="absolute w-full h-full z-0">
        <div
          ...
          style={{
            ...
            left: '-25%',
            background:
              'radial-gradient(circle at 30% 30%, color-mix(in srgb, var(--color-primary-600) 8%, transparent) 0%, transparent 50%), radial-gradient(circle at 70% 70%, color-mix(in srgb, var(--color-primary-600) 6%, transparent) 0%, transparent 50%)',
        ...
        <div
          ...
          style={{
            ...
            height: 250,
            background:
              'radial-gradient(circle, color-mix(in srgb, var(--color-primary-600) 10%, transparent) 0%, transparent 70%)',
            bottom: '15%',
            left: '10%',
            filter: 'blur(50px)',
        ...
        <div className="container py-3">
          <div className="flex justify-center items-center gap-3">
            <div className="relative">
              <div
                className="absolute w-full h-full rounded-full bg-primary-600 opacity-50"
                style={{ filter: 'blur(20px)', animation: 'pulse 3s ease-in-out infinite' }}
              ></div>
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    '0 8px 20px color-mix(in srgb, var(--color-primary-600) 30%, transparent), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                }}
              >
              ...
              <div className="w-full md:max-w-[83%] lg:max-w-[58%] xl:max-w-[50%]">
                ...
                <div className="relative">
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, color-mix(in srgb, var(--color-primary-600) 20%, transparent), color-mix(in srgb, var(--color-primary-600) 15%, transparent))',
                      filter: 'blur(30px)',
                    }}
                  ></div>
                  ...
                  >
                    {/* Title Banner */}
                    <div
                      className="relative overflow-hidden py-[16px] px-[24px]"
                      style={{
                        background:
                    ...
                    <div className="p-3 md:p-4">
                      ...
                      {(invoiceAmount || invoiceDesc) && (
                        <div
                          ...
                          style={{
                            background:
                              'linear-gradient(135deg, color-mix(in srgb, var(--color-primary-600) 5%, transparent), color-mix(in srgb, var(--color-primary-600) 8%, transparent))',
                            border: '1px solid color-mix(in srgb, var(--color-primary-600) 15%, transparent)',
                          }}
                        >
                          {invoiceAmount && (
                            <div className="mb-1">
                              ...
                              <div
                                className="text-[2rem] tracking-[-1px] leading-[1.2]"
                                style={{
                                  fontWeight: '900',
                                  background:
                                    'linear-gradient(135deg, var(--color-primary-600) 0%, color-mix(in srgb, var(--color-primary-600), #000 25%) 100%)',
                      ...
                      <div className="mb-3 relative">
                        <i
                          className="bx bx-search absolute left-[12px] text-surface-500 text-[18px]"
                        ...
                        <Input
                          ...
                          className="pl-[38px] rounded-[10px] text-[0.875rem]"
                        />
                      </div>
