...
import usePaymentCheckout from '@/components/payment/usePaymentCheckout'
            ...
            <div className="bg-white rounded-xl shadow-lg mx-auto p-0 max-w-[500px]">
              <div className="text-center p-5">
                ...
                <h4 className="mb-3 text-surface-900" suppressHydrationWarning>
                  {t('payment.notFoundTitle', { defaultValue: 'Payment Not Found' })}
                </h4>
                <p className="text-surface-500 text-[0.9rem]" suppressHydrationWarning>
                  {error || t('payment.notFoundMessage', { defaultValue: 'This payment link is invalid or has expired. Please check the URL and try again.' })}
                </p>
              </div>
            </div>
          ) : (
            <div className="flex justify-center relative z-[1]">
              <div className="w-11/12 sm:w-8/12 md:w-7/12 lg:w-4/12">
                <div className="relative">
                  ...
                  >
                    {/* Status Banner (visible when network already selected) */}
                    {!needsNetworkSelection && (
                      <div
