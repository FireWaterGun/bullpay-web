...
export default function RbfSettingsPage() {
  ...
  async function handleSaveGlobal() {
    ...
    const errors = {}
    if (group === 'droppedDetection') {
      const e1 = validateNumber(editForm.minNotFoundCount, {
        min: 1,
        integer: true,
        fieldLabel: 'Min Not-Found Checks',
      })
      if (e1) errors.minNotFoundCount = e1
      const e2 = validateNumber(editForm.minNotFoundDuration, {
        min: 0,
        integer: true,
        fieldLabel: 'Min Not-Found Duration',
      })
      ...
      const e1 = validateNumber(editForm.maxReplacementsPerTx, {
        min: 1,
        integer: true,
        fieldLabel: 'Max Replacements',
      })
  ...
  async function handleSaveNetwork() {
    ...
    const e4 = validateNumber(editForm.minTimeBetweenReplaces, {
      min: 0,
      integer: true,
      fieldLabel: 'Replace Interval',
    })
      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-surface-500 mb-0">
            {t('admin.rbfSettings.subtitle', {
              defaultValue: 'Configure Replace-by-Fee behavior for stuck transactions across all EVM networks',
            })}
          </p>
        </div>
      </div>
