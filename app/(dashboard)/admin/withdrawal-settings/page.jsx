...
export default function WithdrawalSettingsPage() {
  ...
  const [cnPagination, setCnPagination] = useState({ page: 1, limit: 20, total: 0, totalPages: 0, hasPrev: false, hasNext: false });
    ...
    <div className="grow py-6">
      ...
      {activeTab === 'policy' && (
        <PolicyTab
          ...
          onEditMaxPending={() => { setMaxPendingForm(maxPending); setShowMaxPendingModal(true); }} />
      )}
      ...
      {activeTab === 'basefee' && (
        <BaseFeeTab
          ...
          onEditBuffer={() => { setBufferForm(bufferMultiplier); setShowBufferModal(true); }}
          onEditAlert={() => { setAlertForm(alertThreshold); setShowAlertModal(true); }} />
      )}
      ...
      {showMaxPendingModal && (
        <SettingModal
          ...
          <small className="text-surface-500">{t('admin.withdrawalSettings.editMaxPendingHint', { defaultValue: 'Recommended: 3–10' })}</small>
        </SettingModal>
      )}
      ...
      {showBufferModal && (
        <SettingModal
          ...
          <small className="text-surface-500">{t('admin.withdrawalSettings.editBufferHint', { defaultValue: '1.0 = no buffer, 1.2 = 20% safety margin, 1.5 = 50% buffer' })}</small>
        </SettingModal>
      )}
      ...
      {showAlertModal && (
        <SettingModal
          ...
          <small className="text-surface-500">{t('admin.withdrawalSettings.editAlertHint', { defaultValue: '0.1 = 10%, 0.2 = 20%, 0.5 = 50%' })}</small>
        </SettingModal>
      )}
        ...
        <div className="p-5">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <small className="text-surface-500 uppercase font-semibold text-[0.7rem] tracking-[0.5px]">
                {label}
              </small>
