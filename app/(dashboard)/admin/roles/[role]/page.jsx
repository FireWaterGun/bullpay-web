    ...
    <div className="grow py-6">
      ...
      <div className="flex items-start justify-between flex-wrap gap-3 mb-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          {overrides.length > 0 &&
          <Button onClick={() => setShowResetModal(true)} size="sm" className="border border-warning-500 text-warning-500 bg-transparent hover:bg-warning-500 hover:text-white">
