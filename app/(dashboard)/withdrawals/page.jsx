...
import {
  ...
  statusBadgeClass,
  formatStatusLabel,
  WITHDRAWAL_STATUSES } from
'@/components/balance/withdrawalHelpers';
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-surface-100 text-surface-500 text-xs uppercase tracking-wider">
                    ...
                    <th className="py-3 px-3 text-left font-medium min-w-[180px]">{t('wallet.colCoin', { defaultValue: 'Coin' })}</th>
