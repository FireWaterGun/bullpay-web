...
const STATUS_MAPS = {
  invoice: {
    ...
    pending: 'warning', detecting: 'warning',
    confirming: 'info', processing: 'info',
    expired: 'neutral', cancelled: 'neutral', canceled: 'neutral',
    failed: 'danger', unconfirmed: 'danger',
  },
  payment: {
    confirmed: 'success', completed: 'success',
    detecting: 'warning', pending: 'warning',
    confirming: 'info', processing: 'info',
    failed: 'danger', unconfirmed: 'danger',
    expired: 'neutral', cancelled: 'neutral', canceled: 'neutral',
  },
  sweep: {
    ...
    pending: 'warning',
    processing: 'info', approved: 'info',
    failed: 'danger', rejected: 'danger', error: 'danger',
    cancelled: 'neutral', canceled: 'neutral',
  },
  withdrawal: {
    completed: 'success', success: 'success',
    pending: 'warning', waiting_for_gas: 'warning',
    processing: 'info', approved: 'info',
    failed: 'danger', rejected: 'danger', error: 'danger',
    cancelled: 'neutral', canceled: 'neutral',
  },
  ...
  tempWallet: {
    active: 'success', pooled: 'success',
    assigned: 'info',
    used: 'warning', sweeped: 'warning',
    expired: 'danger', disabled: 'danger',
  },
  tempWalletHistory: {
    assigned: 'info',
    deposited: 'primary',
