...
export async function rotateSecret(token: string | null) {
...
export async function regenerateKey(token: string | null) {
...
export async function updateWebhook(token: string | null, callbackUrl: string) {
