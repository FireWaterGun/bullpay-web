...
import { getUserBalanceDetail } from '../../api/admin.ts'
...
export default function UserBalanceDetail() {
  ...
  async function loadDetail() {
    ...
    try {
      ...
      console.error('Failed to load user balance detail:', error)
    ...
    <div className="container-xxl flex-grow-1 container-p-y">
      <div className="row">
        <div className="col-12">
          <button className="btn btn-outline-secondary mb-3" onClick={() => navigate('/admin/user-balances')}>
                        ...
                        return (
                          <tr key={asset.coinNetworkId || idx}>
                            ...
                            <td className="text-end text-nowrap">
                              <span className="fw-medium">{asset.confirmedBalance || '0'}</span>
                            </td>
                            <td className="text-end text-nowrap">
                            ...
                            <td className="text-end text-nowrap">
                              <span className="fw-medium">{asset.totalBalance || '0'}</span>
                            </td>
                            <td className="text-end text-nowrap">
                              <span className="fw-medium">${asset.priceUsd ?? '-'}</span>
                            </td>
                            <td className="text-end text-nowrap">
                              <span className="fw-medium">
                                ${asset.valueUsd || '0.00'}
