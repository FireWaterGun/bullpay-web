...
import SweepTransactionFilters from './SweepTransactionFilters'
import SweepTransactionTable from './SweepTransactionTable'
      ...
      <div className="row">
        <div className="col-12">
          ...
          <SweepTransactionTable
            ...
            onNavigate={(id) => navigate(`/admin/sweeps/${id}`)}
            onRetry={handleRetry}
