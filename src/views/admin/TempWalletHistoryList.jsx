...
import { getTempWalletHistories } from '../../api/admin.ts'
...
export default function TempWalletHistoryList() {
  ...
  async function loadHistories() {
    ...
    try {
      ...
      console.error('Failed to load temp wallet histories:', error)
            ...
            <div className="card-header">
              <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div className="d-flex gap-2">
                  <button className="btn btn-outline-secondary" onClick={() => navigate('/admin/temp-wallets')}>
                        ...
                        <tr key={h.id}>
                          ...
                          <td className="text-center">
                            <a
                              ...
                              onClick={(e) => { e.preventDefault(); navigate(`/admin/temp-wallets/${h.tempWalletId}`) }}
                            >
                              {h.tempWalletId || '-'}
                            </a>
                          </td>
                          <td className="text-center">
                            {h.invoiceId ? (
                              <a
                                href="#"
                                className="text-primary fw-medium"
                                onClick={(e) => { e.preventDefault(); navigate(`/admin/invoices/${h.invoiceId}`) }}
                              >
                                {h.invoiceId}
                              </a>
                            ) : (
                          ...
                          <td>
                            <button
                              ...
                              onClick={() => navigate(`/admin/temp-wallet-histories/${h.id}`)}
                              title="View detail"
                            >
