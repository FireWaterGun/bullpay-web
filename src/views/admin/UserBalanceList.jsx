...
import { getUserBalances, getUserBalancesSummary } from '../../api/admin.ts'
...
export default function UserBalanceList() {
                  ...
                  <tbody>
                    {users.length === 0 ? (
                      ...
                      users.map((u) => (
                        <tr key={u.userId}>
                          <td>
                            <span className="fw-semibold text-primary">{u.userId}</span>
                          </td>
                          <td>
                          ...
                          <td className="text-center">
                            <span className="fw-medium">{u.totalAssets ?? 0}</span>
                          </td>
                          <td className="text-end text-nowrap">
                            <span className="fw-bold">
                              ${u.totalValueUsd || '0.00'}
                            </span>
                          </td>
                          <td>
                            <span style={{ whiteSpace: 'nowrap', fontSize: '0.85rem' }}>{formatDate(u.valuedAt)}</span>
                          </td>
                          <td>
                            <button
                              className="btn btn-sm btn-icon btn-text-secondary"
                              onClick={() => navigate(`/admin/user-balances/${u.userId}`)}
                              title="View detail"
                            >
