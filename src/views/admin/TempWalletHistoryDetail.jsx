...
import { getTempWalletHistory } from '../../api/admin.ts'
...
export default function TempWalletHistoryDetail() {
  ...
  async function loadHistory() {
    try {
      ...
      console.error('Failed to load temp wallet history:', error)
    ...
    <div className="container-xxl flex-grow-1 container-p-y">
      <div className="row">
        <div className="col-12">
          <button className="btn btn-outline-secondary mb-3" onClick={() => navigate('/admin/temp-wallet-histories')}>
                      ...
                      <tr>
                        ...
                        <td>
                          <a
                            ...
                            onClick={(e) => { e.preventDefault(); navigate(`/admin/temp-wallets/${history.tempWalletId}`) }}
                          >
                            {history.tempWalletId}
                          </a>
                        </td>
                        ...
                        <td>
                          {history.invoiceId ? (
                            <a
                              href="#"
                              className="fw-medium text-primary"
                              onClick={(e) => { e.preventDefault(); navigate(`/admin/invoices/${history.invoiceId}`) }}
                            >
                              {history.invoiceId}
                            </a>
                          ) : '-'}
