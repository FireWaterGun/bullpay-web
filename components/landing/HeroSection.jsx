...
const FLOAT_COINS = [
  ...
  { img: '/assets/img/coins/eth.svg', style: { top: '18%', left: -20, animationName: 'landing-float-2', animationDelay: '0.8s' } },
  { img: '/assets/img/coins/usdterc20.svg', style: { bottom: '25%', right: -16, animationName: 'landing-float-1', animationDelay: '1.6s' } },
  { img: '/assets/img/coins/sol.svg', style: { bottom: '5%', left: -12, animationName: 'landing-float-2', animationDelay: '2.4s' } },
  { img: '/assets/img/coins/bnb.svg', style: { top: '50%', right: -22, animationName: 'landing-float-1', animationDelay: '3.2s', width: 38, height: 38 } },
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="mb-5 lg:mb-0">
            ...
            <h1 className="text-[2.5rem] sm:text-[3rem] lg:text-[4.2rem] font-extrabold leading-[1.08] text-surface-900 tracking-[-0.035em] mb-5">
              Accept crypto{' '}
              <span className="bg-gradient-to-br from-primary-600 to-violet-600 bg-clip-text text-transparent">payments</span>,
              <br />
              the simple way
            </h1>
          ...
          <div className="relative" ref={mockupRef}>
            ...
            {/* Card glow */}
            <div className="absolute -inset-0.5 rounded-[22px] bg-gradient-to-br from-[rgba(37,99,235,0.2)] via-[rgba(124,58,237,0.12)] to-[rgba(37,99,235,0.08)] blur-[1px] z-0 hidden lg:block" aria-hidden="true"></div>
                    ...
                    {STEPS.map((step, i) => {
                      ...
                      return (
                        <div key={step.label} className="flex items-center gap-3 relative min-h-[46px] pl-1">
                          ...
                          >
                            {step.label}
                            {active && <span className="inline-block w-1.5 h-1.5 rounded-full bg-primary-600 ml-2 align-middle animate-[landing-pulse_1.2s_ease-in-out_infinite]"></span>}
                          </div>
                        </div>
                      )
                    })}
