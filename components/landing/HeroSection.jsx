        ...
        <div className="row align-items-center">
          <div className="col-lg-6 mb-5 mb-lg-0">
            ...
            <div className="d-flex gap-3 flex-wrap mb-5">
              <Link href="/register" className="btn btn-primary btn-lg px-5 py-3 fw-semibold shadow">
                Get Started Free
                    ...
                    <div className="card-body p-4">
                      <div className="d-flex align-items-center justify-content-between mb-3">
                        <div className="d-flex align-items-center gap-3">
                          <Image src="/assets/img/coins/btc.svg" alt="BTC" width={40} height={40} priority />
                          <div>
                ...
                <div className="crypto-card-float mt-4" style={{ animation: 'float 6s ease-in-out infinite 1s', marginLeft: '2rem' }}>
                  <div className="card border-0 shadow-lg">
                    <div className="card-body p-4">
                      <div className="d-flex align-items-center justify-content-between mb-3">
                        <div className="d-flex align-items-center gap-3">
                          <Image src="/assets/img/coins/eth.svg" alt="ETH" width={40} height={40} priority />
                          <div>
                ...
                <div className="crypto-card-float mt-4" style={{ animation: 'float 6s ease-in-out infinite 2s' }}>
                  <div className="card border-0 shadow-lg">
                    <div className="card-body p-4">
                      <div className="d-flex align-items-center justify-content-between mb-3">
                        <div className="d-flex align-items-center gap-3">
                          <Image src="/assets/img/coins/usdterc20.svg" alt="USDT" width={40} height={40} priority />
                          <div>
