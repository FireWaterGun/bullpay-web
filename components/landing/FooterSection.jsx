    ...
    <footer className="py-5 mt-3 bg-transparent">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 py-4">
            ...
            <div className="flex gap-2 mt-3">
              {['bxl-twitter', 'bxl-github', 'bxl-telegram', 'bxl-discord-alt'].map((icon) => (
                <a
                  key={icon}
                  href="#"
                  className="w-9 h-9 rounded-full inline-flex items-center justify-center text-surface-500 transition-[color,background] duration-200 no-underline text-[1.15rem] hover:text-primary-600 hover:bg-[rgba(37,99,235,0.08)]"
                >
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="list-none p-0 text-[0.9rem]">
              ...
              <li className="mb-2">
                <a href="#currencies" className={footerLink}>
                  Currencies
                </a>
              </li>
              <li className="mb-2">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <span className="text-surface-400 text-[0.82rem]">&copy; {year} BULL PAY. All rights reserved.</span>
        </div>
      </div>
    </footer>
  )
