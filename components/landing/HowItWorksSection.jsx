  ...
  return (
    <section className="py-6">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6">
        <div className="py-10 px-6 rounded-2xl sm:py-12 sm:px-8 sm:rounded-[20px] lg:py-20 lg:px-16 lg:rounded-3xl bg-primary-100">
          <div className="text-center mb-5">
            ...
            <p className="text-surface-500 text-[1.1rem] leading-[1.6] mb-0 text-primary-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-5">
            {STEPS.map((step) => (
              <div key={step.num}>
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-[14px] bg-[rgba(37,99,235,0.15)] text-base font-extrabold text-primary-800 mb-3">{step.num}</div>
