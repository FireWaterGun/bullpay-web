        ...
        <div className="flex gap-3 items-center">
          ...
          {!isPaid && (
            <div className="text-center shrink-0">
              <div className="inline-block relative p-2 rounded-lg bg-surface-0">
                <QRCode value={paymentValue} size={130} includeMargin={false} level="H" />
              </div>
              <div className="mt-2 text-xs text-surface-500 font-medium">{t('payment.scanToPay') || 'Scan to Pay'}</div>
            </div>
          )}
          ...
          <div className="grow flex flex-col items-center justify-center min-w-0">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                <div className="text-[1rem] font-bold text-surface-900 leading-[1.2]">{coinSym}</div>
                <div className="text-[0.7rem] text-surface-500 font-medium">on {networkName || 'Network'}</div>
              </div>
            </div>
