      ...
      <table className="w-full">
        ...
        <tbody>
          ...
          <tr key={w.id}>
              ...
              <td>
                <span className="font-monospace text-sm truncate inline-block max-w-[120px]">
              ...
              <td>
                <div className="dropdown">
                  <Button size="icon" className="bg-transparent text-surface-600 hover:bg-surface-100 shadow-none">
