            ...
            <div className="text-center py-12 px-6">
              {loading ? (
                ...
                <>
                  ...
                  <h5 className="mb-2 font-semibold">{t('wallets.verified', { defaultValue: 'Address Verified!' })}</h5>
                  <p className="text-surface-500 mb-3">
                    {t('wallets.verifiedDesc', {
                      defaultValue: 'Your withdrawal address has been verified successfully.',
                    })}
                  </p>
                  <Button href="/withdrawals">{t('wallets.goToWallets', { defaultValue: 'Go to Wallets' })}</Button>
                </>
              ) : error ? (
                <>
