  ...
  return (
    <Card>
      <Table>
        ...
        <tbody>
          {addresses.length === 0 ? (
            <TableEmptyState colSpan={12} icon="bx-map-pin" message="No withdrawal addresses found" />
          ) : (
            addresses.map((addr) => {
                ...
                >
                  ...
                  <td>
                    <div className="flex items-center gap-1 whitespace-nowrap">
                      <span className="text-[0.8rem]">{addr.address || 'N/A'}</span>
                      {addr.address && (
                        <button
                          type="button"
                          onClick={(e) => {
                  ...
                  <td className="text-center whitespace-nowrap">
                    <span className={addressStatusBadgeClass(addr.status)}>{statusLabel(addr.status)}</span>
                  </td>
