  ...
  return (
    <div className="grid grid-cols-12 gap-x-6 gap-3">
      ...
      <div className="md:col-span-3 sm:col-span-6">
        ...
        <input type="number" className="form-input" placeholder={t('filter.walletId', { defaultValue: 'Wallet ID' })} value={walletIdFilter} onChange={(e) => setWalletIdFilter(e.target.value)} />
      </div>
      <div className="md:col-span-3 sm:col-span-6">
