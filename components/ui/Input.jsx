...
const inputBase = [
  ...
  // dark
  'dark:bg-transparent dark:border-dark-border dark:text-surface-900-text',
  'dark:placeholder:text-surface-900-text-muted',
  'dark:hover:not-focus:not-disabled:not-read-only:border-dark-border-hover',
  'dark:focus:border-primary-500 dark:focus:shadow-input-focus-dark',
  'dark:disabled:bg-white/6 dark:disabled:border-white/12 dark:disabled:text-surface-900-text-muted',
  'dark:read-only:bg-white/6 dark:read-only:border-white/12 dark:read-only:text-surface-900-text-muted',
].join(' ')
...
function InputGroup(props) {
  ...
  const cls = [
    ...
    // dark
    'dark:border-dark-border dark:hover:border-dark-border-hover',
...
function InputIcon(props) {
  ...
  const cls = [
    ...
    'dark:text-surface-900-text-muted dark:hover:text-surface-900-text',
    className,
  ].filter(Boolean).join(' ')
...
function InputAddon({ className = '', children, ...rest }) {
  const cls = [
    ...
    'dark:bg-dark-elevated dark:text-surface-900-text-secondary',
    className,
  ].filter(Boolean).join(' ')
