    ...
    <div className="col-span-12 xl:col-span-4">
      <Card className="mb-4">
        <h5 className="px-5 py-4 border-b border-surface-200">
          {t('crypto.networkInfo', { defaultValue: 'Network Info' })}
        </h5>
        <div className="p-5">
                ...
                {networkMeta.supportedCoins.map((coin) => (
                  <div key={coin.id} className="py-3 first:pt-0 last:pb-0 flex justify-between items-center">
                    ...
                    <div className="text-right">
                      <Badge color={coin.status === 'active' ? 'success' : 'secondary'} label className="mr-1">
                        {coin.status}
                      </Badge>
                      {coin.depositEnabled && (
                        <Badge color="info" label className="mr-1">
                          Deposit
                        </Badge>
                      )}
