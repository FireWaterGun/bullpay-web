      ...
      <div className="p-5">
        <form onSubmit={handleSubmit}>
            ...
            <div className="col-span-12 md:col-span-6">
              <div className="flex items-center justify-between p-3 border rounded">
                <div>
                  ...
                  <small className="text-surface-500">
                    {t('crypto.allowWithdrawals', { defaultValue: 'Allow users to withdraw' })}
                  </small>
                </div>
          ...
          <div className="flex gap-2 justify-end mt-5">
            <Button type="button" onClick={onCancel} disabled={loading} variant="outline-secondary">
              <i className="bx bx-x mr-1"></i>
              {t('actions.cancel', { defaultValue: 'Cancel' })}
            </Button>
            <Button type="submit" disabled={loading || !formData.coinId || !formData.networkId}>
