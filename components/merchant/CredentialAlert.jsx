  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="merchant-credentials-title"
      ...
      >
        ...
        <div className="p-6">
          <div
            className="rounded-lg bg-warning-50 dark:bg-warning-950/30 text-warning-700 dark:text-warning-400 py-2 px-3 mb-4"
            role="alert"
          >
            ...
            <div className="mb-3">
              ...
              <InputGroup>
                ...
                <Button onClick={() => handleCopy(credentials.apiKey, setCopiedKey)} variant="outline-secondary">
                  ...
                  {copiedKey
                    ? t('merchant.copied', { defaultValue: 'Copied!' })
