          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="md:col-span-2">
                ...
                <Input name="description" value={form.description} onChange={handleChange} placeholder={t('merchant.descPlaceholder', { defaultValue: 'Describe your business...' })} rows={3} maxLength={1000} />
              </div>
            ...
            <div className="flex justify-between gap-3 mt-4 pt-3 border-t border-surface-200">
              ...
              <Button type="submit" disabled={loading} className="px-5">
                {loading ?
                <><Spinner className="w-4 h-4 mr-2 inline-block align-middle" />{t('merchant.registering', { defaultValue: 'Registering...' })}</> :
