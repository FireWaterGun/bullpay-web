            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between mb-4 p-3 rounded bg-surface-100 dark:bg-white/[0.03]">
                <div>
                  ...
                  <br />
                  <small className="text-surface-500">{t('admin.withdrawalSettings.withdrawEnabledDesc', { defaultValue: 'Allow users to withdraw this coin on this network' })}</small>
                </div>
              ...
              <div className="grid grid-cols-12 gap-x-6 gap-3">
                ...
                <div className="md:col-span-6">
                  ...
                  <Input
                    ...
                    disabled
                    readOnly />
                  <small className="text-surface-500">{t('admin.withdrawalSettings.feeBaseHint', { defaultValue: 'Managed by Base Fee Auto-Update' })}</small>
                </div>
                ...
                <div className="md:col-span-6">
                  ...
                  <small className="text-surface-500">{t('admin.withdrawalSettings.feePercentHint', { defaultValue: 'Platform fee charged on withdrawal amount' })}</small>
                </div>
                ...
                <div className="md:col-span-6">
                  ...
                  <small className="text-surface-500">{t('admin.withdrawalSettings.dailyLimitHint', { defaultValue: 'Max USD value per user per day (empty = no limit)' })}</small>
                </div>
              </div>
            </div>
