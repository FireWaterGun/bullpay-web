...
export default function PermissionActionModal({
  action,
  role,
  permission,
  reason,
      ...
      <div className="w-full max-w-lg mx-4" onClick={(e) => e.stopPropagation()}>
        <div className="bg-card rounded-xl shadow-xl">
          ...
          <div className="p-5">
            <div className="mb-3">
              ...
              <small className="text-surface-500 mt-1 block">
                {t('admin.permissions.enterPermission', {
                  defaultValue: 'Enter the permission to {{verb}} {{role}}',
                  verb: cfg.verb,
            ...
            <div>
              <Label>
                {t('admin.permissions.reason', { defaultValue: 'Reason' })}{' '}
                <span className="text-surface-500">
                  {t('admin.permissions.optional', { defaultValue: '(optional)' })}
                </span>
              </Label>
              <Input
                rows="2"
          ...
          <div className="flex items-center justify-end gap-2 p-5 border-t border-surface-200">
            ...
            <Button onClick={onSubmit} variant={cfg.btnVariant} disabled={!permission.trim() || disabled}>
              <i className={`bx ${cfg.btnIcon} mr-1`}></i>
              {cfg.btnLabel}
            </Button>
          </div>
        </div>
