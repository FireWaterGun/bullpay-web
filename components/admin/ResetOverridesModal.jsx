        ...
        <div className="bg-card rounded-xl shadow-xl">
          ...
          <div className="p-5">
            <Alert variant="warning" className="mb-3">
              ...
              {t('admin.permissions.resetConfirm', {
                defaultValue: 'This will remove all {{count}} overrides for this role and restore default permissions.',
                count: overridesCount,
              })}
            </Alert>
            <p className="text-surface-500 mb-0">
              {t('admin.permissions.cannotBeUndone', { defaultValue: 'This action cannot be undone.' })}
            </p>
          </div>
            ...
            >
              {actionLoading === '__reset__' ? (
                <>
                  ...
                  {t('admin.permissions.resetting', { defaultValue: 'Resetting...' })}
                </>
              ) : (
                <>
