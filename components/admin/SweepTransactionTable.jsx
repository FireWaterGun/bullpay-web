                  ...
                  <tr key={sweep.id} style={{ cursor: 'pointer' }} onClick={() => onNavigate(sweep.id)}>
                    ...
                    <td style={{ whiteSpace: 'nowrap' }}>
                      <div className="flex items-center">
                        ...
                        />
                        <div>
                          <div className="font-medium" style={{ lineHeight: 1.2 }}>{(sweep.coinNetwork?.coin?.symbol || '-').toUpperCase()}</div>
                    ...
                    <td className="text-center">
                      {['failed', 'error'].includes(String(sweep.status || '').toLowerCase()) ? (
                        <button
                          className="btn btn-sm btn border border-warning-500 text-warning-500 bg-transparent hover:bg-warning-500 hover:text-white"
