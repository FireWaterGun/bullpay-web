      ...
      <div className="w-full max-w-lg mx-4" onClick={(e) => e.stopPropagation()}>
        <div className="bg-card rounded-xl shadow-xl">
          ...
          <div className="p-5">
            <p className="mb-0">
              {target.type === 'baseFee'
                ? t('admin.network.deleteBaseFeeConfirm', {
                    defaultValue: `Are you sure you want to delete base fee for ${target.network}?`,
                    network: target.network,
                  })
                : t('admin.network.deleteSlippageConfirm', {
                    defaultValue: `Are you sure you want to delete slippage for ${target.network}?`,
                    network: target.network,
                  })}
            </p>
          </div>
