              ...
              <div className="flex justify-between items-center flex-wrap gap-3">
                <div>
                  ...
                  <p className="text-surface-500 mb-0">
                    {t('admin.tempWalletHistories.description', {
                      defaultValue: 'Monitor wallet usage history (read-only)',
                    })}
                  </p>
                </div>
            ...
            <div className="p-5">
              <div className="grid grid-cols-12 gap-x-6 gap-3">
                ...
                <div className="col-span-12 sm:col-span-6 md:col-span-3">
                  ...
                  <Input
                    type="number"
                    placeholder={t('admin.tempWalletHistories.tempWalletId', { defaultValue: 'Temp Wallet ID' })}
                    value={tempWalletIdFilter}
                    onChange={(e) => setTempWalletIdFilter(e.target.value)}
                  />
                </div>
                <div className="col-span-12 sm:col-span-6 md:col-span-3">
              ...
              <thead>
                <tr className="whitespace-nowrap">
                  ...
                  <th className="text-center">
                    {t('admin.tempWalletHistories.walletId', { defaultValue: 'Wallet ID' })}
                  </th>
                  ...
                  histories.map((h) => (
                    <tr key={h.id}>
                      ...
                      <td className="text-center">
                        <Link href={`/admin/temp-wallets/${h.tempWalletId}`} className="text-primary font-medium">
                          {h.tempWalletId || '-'}
                        </Link>
                      </td>
                      <td className="text-center">
                        {h.invoiceId ? (
                          <Link href={`/admin/invoices/${h.invoiceId}`} className="text-primary font-medium">
                            {h.invoiceId}
                          </Link>
                        ) : (
                        ...
                        {(() => {
                          ...
                          return (
                            <div className="flex items-center">
                              <CoinImg
                                symbol={sym}
                                networkSymbol={(cn.network?.symbol || '').toUpperCase()}
                                size={24}
                                className="mr-3"
                              />
                              <div>
