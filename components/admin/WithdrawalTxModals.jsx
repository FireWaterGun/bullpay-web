...
export default function WithdrawalTxModals({
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => !approving && setShowApproveModal(false)}>
          <div className="w-full max-w-lg mx-4" onClick={(e) => e.stopPropagation()}>
            <div className="bg-card rounded-xl shadow-xl">
              <div className="flex items-center justify-between p-5 border-b border-surface-200">
                ...
                <button type="button" className="cursor-pointer text-surface-500 hover:text-surface-700 text-xl leading-none" onClick={() => setShowApproveModal(false)} disabled={approving}><i className="bx bx-x"></i></button>
              </div>
              <div className="p-5">
                ...
                <Card className="bg-surface-100 dark:bg-dark-elevated border border-surface-200">
                  <div className="p-5">
                    <div className="grid grid-cols-12 gap-x-6 gap-2">
                      ...
                      <div className="col-span-6">
                        <small className="text-surface-500 block">{t('withdrawal.amount', { defaultValue: 'Amount' })}</small>
                      ...
                      <div className="col-span-12">
                        <small className="text-surface-500 block">{t('withdrawal.toAddress', { defaultValue: 'To Address' })}</small>
              ...
              <div className="flex items-center justify-end gap-2 p-5 border-t border-surface-200">
                <Button type="button" onClick={() => setShowApproveModal(false)} disabled={approving} className="bg-surface-200 text-surface-700 hover:bg-surface-300 dark:bg-dark-elevated dark:hover:bg-white/10">
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => !rejecting && setShowRejectModal(false)}>
          <div className="w-full max-w-lg mx-4" onClick={(e) => e.stopPropagation()}>
            <div className="bg-card rounded-xl shadow-xl">
              <div className="flex items-center justify-between p-5 border-b border-surface-200">
                <h5 className="text-lg font-semibold text-surface-800">
                ...
                <button type="button" className="cursor-pointer text-surface-500 hover:text-surface-700 text-xl leading-none" onClick={() => setShowRejectModal(false)} disabled={rejecting}><i className="bx bx-x"></i></button>
              </div>
              <div className="p-5">
                ...
                <div className="mb-3">
                  ...
                  <div className="flex justify-between mt-1">
                    <small className={`${rejectReason.trim().length > 0 && rejectReason.trim().length < 10 ? 'text-danger' : 'text-surface-500'}`}>
              ...
              <div className="flex items-center justify-end gap-2 p-5 border-t border-surface-200">
                <Button type="button" onClick={() => setShowRejectModal(false)} disabled={rejecting} className="bg-surface-200 text-surface-700 hover:bg-surface-300 dark:bg-dark-elevated dark:hover:bg-white/10">
                  {t('actions.cancel', { defaultValue: 'Cancel' })}
                </Button>
